...
def get_arguments():
    ...
    parser.add_argument('amount', type=int, nargs='?', help='The starting amount of animals that live in the simulation (default =200)', default=200)
    parser.add_argument('-t','--time', type=float, help='Time in seconds per timestep (default = 0.05 second)', default=0.05)
    parser.add_argument('-d','--dimension', type=int, nargs=2, help='Dimension (x and y) of the world (default = 100 100 )', default=(100, 100))
